    ...
    <div class="col-md-9 col-md-offset-1">
        <div class="well well-sm">
            <form class="form-horizontal" action="gravaPedido.php" method="post" novalidate>
                <fieldset>
                    <legend class="text-center">Novo Pedido</legend>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-3 control-label" for="preco_compra">Preço de Compra</label>
                        <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-3 control-label" for="margem">Margem (%)</label>
                        <div class="col-md-3">
